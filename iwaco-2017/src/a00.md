...
% <kbd class="key">space</kbd>: next slide; <kbd class="key">shift</kbd> <kbd class="key">space</kbd>: prev slide; <kbd class="key">esc</kbd>: overview; arrows&nbsp;navigate <a href="pnkfx.org/presentations/iwaco-2017.html"><code>http://bit.ly/2rM9w0r</code></a>
